...
void runFlowTests() {
    ...
    proto::TakeChallengeRewardCsReq claim;
    claim.group_id = 100;
    client.send(cmd::TakeChallengeRewardCsReq, claim);
    proto::TakeChallengeRewardScRsp claimed;
    check(client.await(cmd::TakeChallengeRewardScRsp, packet) && parseBody(packet, claimed) &&
